...
<head>
  ...
  <meta name="_csrf_header" content="${_csrf.headerName}">
    ...
    <title>Stylist Login — Fight D Fear</title>
    ...
    <div class="auth-container">
        ...
        <div class="form-panel">
            <div class="login-card">
                ...
                <h2>Welcome Back 👋</h2>
                <p class="subtitle">Stylist Management Portal</p>
                ...
                <form action="${pageContext.request.contextPath}/stylists/login" method="post">
  <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
                    <div class="fdf-form-group">
                        <label>Email Address</label>
                        <div class="input-wrapper">
                            <i class="bi bi-envelope"></i>
                            <input type="email" name="email" class="fdf-input" placeholder="Enter your email" required>
                        </div>
                    </div>
                    <div class="fdf-form-group">
                    ...
                    <div class="form-options">
                        <label class="remember-me">
                            <input type="checkbox" name="remember" style="width:18px; height:18px; accent-color:var(--brand-pink);">
                            Remember Me
                        </label>
                ...
                <p class="register-link">
                    Don't have an account? <a href="${pageContext.request.contextPath}/stylists/register">Join as Stylist</a>
                </p>
            </div>
        </div>
    </div>
