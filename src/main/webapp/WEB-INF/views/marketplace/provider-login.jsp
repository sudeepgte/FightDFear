...
<head>
  ...
  <meta name="_csrf_header" content="${_csrf.headerName}">
    ...
    <title>Provider Sign In — Fight D Fear</title>
...
<body>
    ...
    <main class="main-container">
        <div class="form-card">
            <div class="card-header">
                ...
                <p>Manage your services, requests and profile</p>
            </div>
  ...
  <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" class="form-input" placeholder="vendor@example.com" 
            ...
            <div class="login-footer">
                New Provider? <a href="${pageContext.request.contextPath}/marketplace/provider/register">Register here</a>
            </div>
        </div>
