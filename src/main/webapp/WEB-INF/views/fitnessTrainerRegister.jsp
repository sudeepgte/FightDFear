...
<body>
    ...
    <header class="app-header">
        ...
        <div class="header-links">
            <a href="${pageContext.request.contextPath}/fitness/trainer/login">Sign in</a>
        </div>
    </header>
    ...
    <main class="main-container">
        ...
        <div class="info-banner">
            ...
            <p>For Gym, Yoga, Zumba & Wellness coaches. Create your trainer account to set up session timings and accept bookings.</p>
            <p class="subtext">For Dojo, Karate or Martial Arts centres, register under Self-Defense Centres.</p>
        </div>
            ...
            <form id="trainerRegForm" action="${pageContext.request.contextPath}/fitness/trainer/register" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="email" id="email" name="email" class="form-input" placeholder="coach@example.com" required>
                    </div>
                </div>
                ...
                <button type="button" class="btn-submit" onclick="openConfirmationModal()">
                    Create coach account <i class="bi bi-arrow-right"></i>
                </button>
            </form>

            <div class="login-footer">
                Already registered? <a href="${pageContext.request.contextPath}/fitness/trainer/login">Sign in</a>
            </div>
        </div>
    </main>
        ...
        <div class="modal-card">
            <div class="modal-header">
                ...
                <div>
                    ...
                    <p style="font-size: 0.8rem; color: var(--text-gray);">Review your coach profile details</p>
                </div>
            </div>
    ...
    <script>
        ...
        async function handleSendOtp() {
            ...
            try {
                const res = await fetch('${pageContext.request.contextPath}/api/fitness/trainer/otp/send-email', {
                    method: 'POST',
        ...
        async function handleVerifyOtp() {
            ...
            try {
                const res = await fetch('${pageContext.request.contextPath}/api/fitness/trainer/otp/verify-email', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
