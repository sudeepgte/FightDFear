...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .alert-success {
            background: var(--success-bg); border: 1px solid #BBF7D0; color: var(--success);
        }
        .info-alert {
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="email" id="email" name="email" class="form-input"
                               ...
                               value="${not empty registeredEmail ? registeredEmail : (not empty param.email ? param.email : (prefillEmail != null ? prefillEmail : ''))}"
