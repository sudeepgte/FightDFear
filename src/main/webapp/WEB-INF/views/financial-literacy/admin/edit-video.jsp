        ...
        <main class="main">
            ...
            <div class="ap-main-inner" style="max-width: 860px;">
                ...
                <div class="ap-panel p-4">
                    ...
                    <form action="${pageContext.request.contextPath}/financial-literacy/admin/edit-video/${video.id}${not empty _csrf ? '?'.concat(_csrf.parameterName).concat('=').concat(_csrf.token) : ''}" method="POST" id="videoForm" enctype="multipart/form-data" class="needs-validation" novalidate>
