...
<body>
    ...
    <div class="layout">
        ...
        <div class="sidebar">
            ...
            <a href="${pageContext.request.contextPath}/financial-literacy/admin/add-workshop" class="navlink active">
        ...
        <main class="main">
            <div class="mainInner">
                ...
                <div class="admin-card">
                    ...
                    <form action="${pageContext.request.contextPath}/financial-literacy/admin/add-workshop" method="POST">
                        <div class="mb-3">
