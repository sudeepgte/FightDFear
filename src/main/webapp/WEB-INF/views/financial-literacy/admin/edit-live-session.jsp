        ...
        <main class="main">
            ...
            <div class="ap-main-inner" style="max-width: 860px;">
                ...
                <div class="ap-page-head">
                    <div class="ap-page-ico"><i class="fas fa-broadcast-tower"></i></div>
                    <div>
                        <h1>Edit Live Virtual Session</h1>
                        <p>Update speaker details, schedule time, seats capacity, or meeting URL</p>
                    </div>
                </div>
                ...
                <div class="ap-panel p-4">
                    ...
                    <form action="${pageContext.request.contextPath}/financial-literacy/admin/edit-live-session/${session.id}" method="POST" id="liveSessionForm" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3 position-relative">
                            ...
                            <input type="text" class="form-control" id="meetingUrl" name="meetingUrl" value="${meetingUrl}" placeholder="https://zoom.us/j/1234567890" required>
