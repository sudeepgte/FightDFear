...
<head>
    ...
    <title>Lawyer Login — Fight D Fear</title>
...
<body>
    <div class="left-panel">
        <div class="brand">
            ...
            <p class="brand-tagline">Providing expert legal guidance and support. Dedicated to justice and empowerment.</p>
            <ul class="feature-list">
                <li><span class="feat-icon"><i class="bi bi-briefcase"></i></span> Consult Trusted Women Lawyers</li>
                <li><span class="feat-icon"><i class="bi bi-shield-check"></i></span> 24/7 Health & Emergency Support</li>
        ...
        <div class="login-card">
            ...
            <form action="${pageContext.request.contextPath}/lawyer/login" method="post">
                <div class="form-group">
                    ...
                    <div class="input-wrapper"><i class="bi bi-envelope prefix-icon"></i><input type="email" name="email" class="form-input" placeholder="Lawyer@example.com" required></div>
                </div>
                <div class="form-group">
            ...
            <p class="register-link">New Lawyer? <a href="${pageContext.request.contextPath}/lawyer/register">Register here</a></p>
        </div>
    </div>
