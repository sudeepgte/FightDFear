...
<head>
    ...
    <title>Join as Women Lawyer — Fight D Fear</title>
...
<body>
    ...
    <main class="main-container">
        ...
        <div class="info-banner">
            ...
            <p>For qualified women lawyers providing legal guidance. After login, manage your profile and schedule.</p>
            <p class="subtext">For legal counseling and support for women.</p>
        </div>
        ...
        <div class="form-card">
            ...
            <form id="regForm" action="${pageContext.request.contextPath}/lawyer/register" method="post">
                ...
                <!-- Contact Person -->
                <div class="form-group">
                    <label for="contactPerson">Bar Council ID *</label>
                    <input type="text" id="barCouncilId" name="barCouncilId" required class="form-input" placeholder="e.g. MAH/1234/2020">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="email" id="email" name="email" class="form-input" placeholder="lawyer@example.com" required>
                    </div>
                </div>
            ...
            <div class="login-footer">
                Already registered? <a href="${pageContext.request.contextPath}/lawyer/login">Sign in</a>
            </div>
        </div>
    </main>
        ...
        <div class="modal-card">
            ...
            <div class="modal-body">
                <div class="review-row">
                    <span class="label">Lawyer Name:</span>
    ...
    <script>
        ...
        function openConfirmationModal() {
            ...
            if (!name) { showAlert('Lawyer name is required.'); return; }
            ...
            document.getElementById('revBarCouncilId').textContent = barCouncilId || name;
