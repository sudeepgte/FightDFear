...
<head>
    ...
    <title>Entrepreneur Sign In — Fight D Fear</title>
    ...
    <main class="main-container">
        <div class="form-card">
            <div class="card-header">
                ...
                <h2>Entrepreneur Sign In</h2>
                <p>Manage your profile, business pitches, and funding</p>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/entrepreneur/login" method="post">
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" class="form-input" placeholder="entrepreneur@example.com" 
            ...
            <div class="login-footer">
                New Entrepreneur? <a href="${pageContext.request.contextPath}/entrepreneur/register">Register here</a>
            </div>
        </div>
    </main>
