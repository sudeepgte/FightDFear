...
<head>
    ...
    <style>
        ...
        .btn-submit { background: var(--gradient-primary); color: white; padding: 12px 30px; border-radius: 50px; font-weight: 700; border: none; transition: all 0.3s; }
        .btn-submit:hover { filter: brightness(1.1); transform: translateY(-2px); box-shadow: 0 8px 20px rgba(106, 13, 173, 0.3); }
...
<body>
    ...
    <div class="sidebar offcanvas-lg offcanvas-start" tabindex="-1" id="sidebarMenu">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link-custom active" href="${pageContext.request.contextPath}/salon/viewOffers?salonId=${salonId}"><i class="bi bi-tags"></i> <span>Offers & Discounts</span></a>
        </nav>
    </div>
    ...
    <div class="main-content">
        <div class="container-fluid max-w-4xl" style="max-width: 900px; margin: 0 auto;">
            ...
            <div class="mb-4 d-flex align-items-center gap-3">
                ...
                <h2 class="fw-800 m-0 text-purple">Create New Offer / Discount</h2>
            </div>
