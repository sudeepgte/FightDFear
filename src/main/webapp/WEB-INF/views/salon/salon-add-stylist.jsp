...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form action="${pageContext.request.contextPath}/saveStylist${not empty _csrf ? '?'.concat(_csrf.parameterName).concat('=').concat(_csrf.token) : ''}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
