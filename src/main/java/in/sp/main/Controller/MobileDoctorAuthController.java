...
public class MobileDoctorAuthController {
     ...
     * Phase 1: disabled to prevent OTP-bypass / placeholder-document registrations.
     */
    @PostMapping("/register")
    public ResponseEntity<Map<String, Object>> register(@RequestBody(required = false) Map<String, String> body) {
        return ResponseEntity.status(HttpStatus.GONE).body(error(
                "This registration endpoint is retired. Use /api/doctors/provider/register-quick with email OTP."));
    }
