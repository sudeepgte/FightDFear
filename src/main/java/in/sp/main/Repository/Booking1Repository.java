...
public interface Booking1Repository extends JpaRepository<Booking1, Long> {
	  ...
	  List<Booking1> findByUser(User user);
	    ...
	    // Sum revenue for completed bookings between dates
