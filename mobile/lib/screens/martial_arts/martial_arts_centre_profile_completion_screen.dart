...
class MartialArtsCentreProfileCompletionScreen extends StatefulWidget {
  const MartialArtsCentreProfileCompletionScreen({super.key});
...
class _MartialArtsCentreProfileCompletionScreenState
  ...
  Future<void> _useCurrentLocation() async {
    ...
    if (permission == LocationPermission.denied || permission == LocationPermission.deniedForever) {
      if (mounted) setState(() => _error = 'Location permission is required to pin the centre');
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Complete Centre Profile', style: TextStyle(fontWeight: FontWeight.w700)),
      ),
      body: _loading
          ...
          : ListView(
              ...
              children: [
                ...
                _section('2', 'Location', [
                  ...
                  const SizedBox(height: 8),
                  const Text('2.7 Pin centre on map', style: TextStyle(fontSize: 13, color: Color(0xFF64748B))),
